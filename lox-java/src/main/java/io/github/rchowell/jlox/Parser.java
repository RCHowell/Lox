...
import static io.github.rchowell.jlox.TokenType.*;
...
public class Parser {
    ...
    private Stmt classDeclaration() {
        ...
        if (match(LESS)) {
            consume(IDENTIFIER, "Expected superclass identifier");
...
//    }
    ...
    private Expr assignment() {
        ...
        if (match(EQUAL)) {
            ...
            Expr value = or();
            // Extract the variable's identifier
